        ...
        : Scaffold(
            ...
            body: Column(
              children: [
                Row(
                  mainAxisAlignment:
                      MainAxisAlignment.spaceAround, //timf hieeur theem
                  crossAxisAlignment:
                      CrossAxisAlignment.start, //timf hieeur them
                  children: [
                    CircleAvatar(
                    ...
                    SizedBox(
                      //lấy chiều rộng của màn hình x0.5
                      ...
                      child: AspectRatio(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            //hình ảnh ôm trọn cả widget
                            fit: BoxFit.fill,

                            //căn chỉnh vị trí của image
